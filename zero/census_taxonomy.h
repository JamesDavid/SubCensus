...
static inline const char* census_class_id(CensusDeviceClass c) {
    switch(c) {
    case CENSUS_CLASS_GARAGE:
        return "garage";
    case CENSUS_CLASS_CAR_FOB:
        return "car-fob";
    case CENSUS_CLASS_TPMS:
        return "tpms";
    case CENSUS_CLASS_WEATHER:
        return "weather";
    case CENSUS_CLASS_DOORBELL:
        return "doorbell";
    case CENSUS_CLASS_PIR_MOTION:
        return "pir-motion";
    case CENSUS_CLASS_ENERGY_METER:
        return "energy-meter";
    case CENSUS_CLASS_WATER_GAS_METER:
        return "water/gas-meter";
    case CENSUS_CLASS_REMOTE:
        return "remote";
    case CENSUS_CLASS_THERMOSTAT:
        return "thermostat";
    case CENSUS_CLASS_SMART_HOME:
        return "smart-home";
    case CENSUS_CLASS_BEACON:
        return "beacon";
    case CENSUS_CLASS_UNKNOWN:
        return "unknown";
    case CENSUS_CLASS_OTHER:
        return "other";
    default:
        return "unknown";
    }
...
static inline const char* census_class_name(CensusDeviceClass c) {
    ...
    case CENSUS_CLASS_WEATHER:
        return "Weather / environment sensor";
    case CENSUS_CLASS_DOORBELL:
        return "Doorbell";
    case CENSUS_CLASS_PIR_MOTION:
